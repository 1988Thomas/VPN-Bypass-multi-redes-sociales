# ============================================================
# Script: CorregirProxyManager.ps1
# Reemplaza ProxyManager.kt con versión sin conflicto de nombres
# ============================================================
$path = "C:\Thomas\VIP\app\src\main\java\com\ejemplo\vpnbypass\ProxyManager.kt"
$content = @'
...
Write-Host "✅ ProxyManager.kt actualizado correctamente." -ForegroundColor Green
Write-Host ""
Write-Host "Ahora ejecuta estos comandos para subir los cambios:" -ForegroundColor Yellow
Write-Host "  git add app/src/main/java/com/ejemplo/vpnbypass/ProxyManager.kt" -ForegroundColor Cyan
Write-Host "  git commit -m 'fix: use fully qualified names for java.net.Proxy'" -ForegroundColor Cyan
